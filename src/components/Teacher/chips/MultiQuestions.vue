                  ...
                  >
                    <v-radio value={{item.selection[0]}}>
                      <template v-slot:label>
                        <div><strong class="text-success">{{item.selection[0]}}</strong></div>
                      </template>
                    </v-radio>
                    <v-radio value={{item.selection[1]}}>
                      <template v-slot:label>
                        <div><strong class="text-success">{{item.selection[1]}}</strong></div>
                      </template>
                    </v-radio>
                    <v-radio value={{item.selection[2]}}>
                      <template v-slot:label>
                        <div><strong class="text-success">{{item.selection[2]}}</strong></div>
                      </template>
                    </v-radio>
                    <v-radio value={{item.selection[3]}}>
                      <template v-slot:label>
                        <div><strong class="text-success">{{item.selection[3]}}</strong></div>
                      </template>
                    </v-radio>
                  </v-radio-group>
                </v-container>
